...
*v6.0 --- Lessons from 8 Video Build Sessions*
...
Videos tested: Flowboard SaaS (25s) · Flowboard SaaS Rebuild (32s) · Fintech Nova (60s) · Fitness Volt X9 (60s) · Fintech Nova v2 Debug (60s) · Fitness Volt v4 Debug (60s) · Fintech Nova v5 Redesign (60s) · Fitness Volt v5 Asset Refresh (60s)
...
the Fitness Volt v5 asset refresh session.
...
Template tiers by image dependency:
  ...
  **Tier 3: Images required**     ParallaxImageReveal, GenAiFeatures, ThreeDCardFlip,
  (unusable without good images)  SplitScreenMorph, SlideshowSocial
  ------------------------------- -----------------------------------------------------------------------
...
+----------------------------------------------------------------------+
  ...
  **Image Size**   **Allowed Templates**
  ≥1080px wide     Any template including full-bleed (ParallaxImageReveal, SplitScreenMorph, )
  500--1079px      Contained templates at 50--65% card width (ThreeDCardFlip, Showcase,  at reduced cubeSizePercent)
...
Hook (first 10--15%): KineticCaptions, ImpactNumber, or
QuestionReveal. Setup (15--30%): GlassPanel, Tweet, or value
proposition. Rising Action (30--65%): Image templates, feature
lists, data scenes. Climax (65--80%): Peak stat or testimonial.
CTA + Close (80--100%): TextRevealWipe or CallToAction, then
LogoStinger.
